/**
 * Clash Matrix Studio V5.3 - 终极防弹自愈版 (完整版)
...
const ACCADEMIA_TEMPLATE = [
  "rule-providers:",
  "  BM_Telegram: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Telegram/Telegram.yaml\", path: ./ruleset/blackmatrix7/Telegram.yaml}",
  "  BM_YouTube: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/YouTube/YouTube.yaml\", path: ./ruleset/blackmatrix7/YouTube.yaml}",
  "  BM_OpenAI: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/OpenAI/OpenAI.yaml\", path: ./ruleset/blackmatrix7/OpenAI.yaml}",
  "  BM_Claude: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Claude/Claude.yaml\", path: ./ruleset/blackmatrix7/Claude.yaml}",
  "  BM_BiliBili: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/BiliBili/BiliBili.yaml\", path: ./ruleset/blackmatrix7/BiliBili.yaml}",
  "  Alipan_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Alipan/Alipan_Domain.yaml\", path: ./ruleset/Accademia/Alipan_Domain.yaml}",
  "  Apple_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Apple/Apple_Domain.yaml\", path: ./ruleset/Accademia/Apple_Domain.yaml}",
  "  Apple_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Apple/Apple_IP.yaml\", path: ./ruleset/Accademia/Apple_IP.yaml}",
  "  AppleAI_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/AppleAI/AppleAI_Domain.yaml\", path: ./ruleset/Accademia/AppleAI_Domain.yaml}",
  "  AppleNews_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/AppleNews/AppleNews_Domain.yaml\", path: ./ruleset/Accademia/AppleNews_Domain.yaml}",
  "  AqaraCN_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Aqara/AqaraCN._Domain.yaml\", path: ./ruleset/Accademia/AqaraCN._Domain.yaml}",
  "  AqaraGlobal_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Aqara/AqaraGlobal._Domain.yaml\", path: ./ruleset/Accademia/AqaraGlobal._Domain.yaml}",
  "  AqaraGlobal_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Aqara/AqaraGlobal._IP.yaml\", path: ./ruleset/Accademia/AqaraGlobal._IP.yaml}",
  "  BaiduNetDisk_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/BaiduNetDisk/BaiduNetDisk_Domain.yaml\", path: ./ruleset/Accademia/BaiduNetDisk_Domain.yaml}",
  "  BankAU_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankAU_Domain.yaml\", path: ./ruleset/Accademia/BankAU_Domain.yaml}",
  "  BankCA_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankCA_Domain.yaml\", path: ./ruleset/Accademia/BankCA_Domain.yaml}",
  "  BankDE_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankDE_Domain.yaml\", path: ./ruleset/Accademia/BankDE_Domain.yaml}",
  "  BankFR_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankFR_Domain.yaml\", path: ./ruleset/Accademia/BankFR_Domain.yaml}",
  "  BankHK_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankHK_Domain.yaml\", path: ./ruleset/Accademia/BankHK_Domain.yaml}",
  "  BankJP_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankJP_Domain.yaml\", path: ./ruleset/Accademia/BankJP_Domain.yaml}",
  "  BankNL_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankNL_Domain.yaml\", path: ./ruleset/Accademia/BankNL_Domain.yaml}",
  "  BankSG_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankSG_Domain.yaml\", path: ./ruleset/Accademia/BankSG_Domain.yaml}",
  "  BankUK_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankUK_Domain.yaml\", path: ./ruleset/Accademia/BankUK_Domain.yaml}",
  "  BankUS_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Bank/BankUS_Domain.yaml\", path: ./ruleset/Accademia/BankUS_Domain.yaml}",
  "  BlockHttpDNSPlus: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/BlockHttpDNSPlus/BlockHttpDNSPlus.yaml\", path: ./ruleset/Accademia/BlockHttpDNSPlus.yaml}",
  "  China_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/China/China_Domain.yaml\", path: ./ruleset/Accademia/China_Domain.yaml}",
  "  ChinaDNS_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/ChinaDNS/ChinaDNS_Domain.yaml\", path: ./ruleset/Accademia/ChinaDNS_Domain.yaml}",
  "  ChinaDNS_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/ChinaDNS/ChinaDNS_IP.yaml\", path: ./ruleset/Accademia/ChinaDNS_IP.yaml}",
  "  ChinaMax_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/ChinaMax/ChinaMax_Domain.yaml\", path: ./ruleset/Accademia/ChinaMax_Domain.yaml}",
  "  Copilot_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Copilot/Copilot_Domain.yaml\", path: ./ruleset/Accademia/Copilot_Domain.yaml}",
  "  FakeLocationBiliBili: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationBiliBili.yaml\", path: ./ruleset/Accademia/FakeLocationBiliBili.yaml}",
  "  FakeLocationDouBan: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationDouBan.yaml\", path: ./ruleset/Accademia/FakeLocationDouBan.yaml}",
  "  FakeLocationDouYin: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationDouYin.yaml\", path: ./ruleset/Accademia/FakeLocationDouYin.yaml}",
  "  FakeLocationKuaiShou: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationKuaiShou.yaml\", path: ./ruleset/Accademia/FakeLocationKuaiShou.yaml}",
  "  FakeLocationTieBa: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationTieBa.yaml\", path: ./ruleset/Accademia/FakeLocationTieBa.yaml}",
  "  FakeLocationWeiBo: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationWeiBo.yaml\", path: ./ruleset/Accademia/FakeLocationWeiBo.yaml}",
  "  FakeLocationXiGua: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationXiGua.yaml\", path: ./ruleset/Accademia/FakeLocationXiGua.yaml}",
  "  FakeLocationXianYu: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationXianYu.yaml\", path: ./ruleset/Accademia/FakeLocationXianYu.yaml}",
  "  FakeLocationXiaoHongShu: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationXiaoHongShu.yaml\", path: ./ruleset/Accademia/FakeLocationXiaoHongShu.yaml}",
  "  FakeLocationZhiHu: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/FakeLocation/FakeLocationZhiHu.yaml\", path: ./ruleset/Accademia/FakeLocationZhiHu.yaml}",
  "  Fastly_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Fastly/Fastly_IP.yaml\", path: ./ruleset/Accademia/Fastly_IP.yaml}",
  "  Gemini_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Gemini/Gemini_Domain.yaml\", path: ./ruleset/Accademia/Gemini_Domain.yaml}",
  "  GeositeCN_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeositeCN/GeositeCN_Domain.yaml\", path: ./ruleset/Accademia/GeositeCN_Domain.yaml}",
  "  GlobalDNS_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GlobalDNS/GlobalDNS_Domain.yaml\", path: ./ruleset/Accademia/GlobalDNS_Domain.yaml}",
  "  GlobalDNS_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GlobalDNS/GlobalDNS_IP.yaml\", path: ./ruleset/Accademia/GlobalDNS_IP.yaml}",
  "  Grok_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Grok/Grok_Domain.yaml\", path: ./ruleset/Accademia/Grok_Domain.yaml}",
  "  HijackingPlus: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/HijackingPlus/HijackingPlus.yaml\", path: ./ruleset/Accademia/HijackingPlus.yaml}",
  "  HomeIPJP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/HomeIP/HomeIPJP.yaml\", path: ./ruleset/Accademia/HomeIPJP.yaml}",
  "  HomeIPUS: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/HomeIP/HomeIPUS.yaml\", path: ./ruleset/Accademia/HomeIPUS.yaml}",
  "  Kwai_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Kwai/Kwai_Domain.yaml\", path: ./ruleset/Accademia/Kwai_Domain.yaml}",
  "  MacAppUpgrade_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/MacAppUpgrade/MacAppUpgrade_Domain.yaml\", path: ./ruleset/Accademia/MacAppUpgrade_Domain.yaml}",
  "  MicrosoftAPPs_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/MicrosoftAPPs/MicrosoftAPPs_Domain.yaml\", path: ./ruleset/Accademia/MicrosoftAPPs_Domain.yaml}",
  "  Parsec_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Parsec/Parsec_Domain.yaml\", path: ./ruleset/Accademia/Parsec_Domain.yaml}",
  "  Pornhub_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/Pornhub/Pornhub_Domain.yaml\", path: ./ruleset/Accademia/Pornhub_Domain.yaml}",
  ...
  "  Paypal: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/VirtualFinance/Paypal.yaml\", path: ./ruleset/Accademia/Paypal.yaml}",
  "  Wise: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/VirtualFinance/Wise.yaml\", path: ./ruleset/Accademia/Wise.yaml}",
  "  Monzo: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/VirtualFinance/Monzo.yaml\", path: ./ruleset/Accademia/Monzo.yaml}",
  "  Revolut: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/VirtualFinance/Revolut.yaml\", path: ./ruleset/Accademia/Revolut.yaml}",
  "  WaybackMachine_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/WaybackMachine/WaybackMachine_Domain.yaml\", path: ./ruleset/Accademia/WaybackMachine_Domain.yaml}",
  "  WaybackMachine_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/WaybackMachine/WaybackMachine_IP.yaml\", path: ./ruleset/Accademia/WaybackMachine_IP.yaml}",
  "  WeiYun_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/WeiYun/WeiYun_Domain.yaml\", path: ./ruleset/Accademia/WeiYun_Domain.yaml}",
  "  WeiYun_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/WeiYun/WeiYun_IP.yaml\", path: ./ruleset/Accademia/WeiYun_IP.yaml}",
  "  eMuleServer_IP: {type: http, behavior: ipcidr, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/eMuleServer/eMuleServer_IP.yaml\", path: ./ruleset/Accademia/eMuleServer_IP.yaml}",
  "  GeoRouting_Africa_Central_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Africa_Central_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_Central_ccTLD_Domain.yaml}",
  "  GeoRouting_Africa_East_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Africa_East_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_East_ccTLD_Domain.yaml}",
  "  GeoRouting_Africa_North_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Africa_North_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_North_ccTLD_Domain.yaml}",
  "  GeoRouting_Africa_South_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Africa_South_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_South_ccTLD_Domain.yaml}",
  "  GeoRouting_Africa_West_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Africa_West_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_West_ccTLD_Domain.yaml}",
  "  GeoRouting_America_North_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_America_North_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_America_North_ccTLD_Domain.yaml}",
  "  GeoRouting_America_South_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_America_South_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_America_South_ccTLD_Domain.yaml}",
  "  GeoRouting_Antarctica_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Antarctica_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Antarctica_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_Central_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_Central_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_Central_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_China_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_China_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_China_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_EastSouth_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_EastSouth_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_EastSouth_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_East_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_East_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_East_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_South_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_South_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_South_ccTLD_Domain.yaml}",
  "  GeoRouting_Asia_West_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Asia_West_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_West_ccTLD_Domain.yaml}",
  "  GeoRouting_Europe_East_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Europe_East_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Europe_East_ccTLD_Domain.yaml}",
  "  GeoRouting_Europe_West_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Europe_West_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Europe_West_ccTLD_Domain.yaml}",
  "  GeoRouting_Oceania_ccTLD_Domain: {type: http, behavior: domain, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_Domain/GeoRouting_Oceania_ccTLD_Domain.yaml\", path: ./ruleset/Accademia/GeoRouting_Oceania_ccTLD_Domain.yaml}",
  "  GeoRouting_Africa_Central_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Africa_Central_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_Central_GeoIP.yaml}",
  "  GeoRouting_Africa_East_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Africa_East_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_East_GeoIP.yaml}",
  "  GeoRouting_Africa_North_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Africa_North_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_North_GeoIP.yaml}",
  "  GeoRouting_Africa_South_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Africa_South_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_South_GeoIP.yaml}",
  "  GeoRouting_Africa_West_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Africa_West_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Africa_West_GeoIP.yaml}",
  "  GeoRouting_America_North_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_America_North_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_America_North_GeoIP.yaml}",
  "  GeoRouting_America_South_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_America_South_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_America_South_GeoIP.yaml}",
  "  GeoRouting_Antarctica_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Antarctica_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Antarctica_GeoIP.yaml}",
  "  GeoRouting_Asia_Central_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_Central_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_Central_GeoIP.yaml}",
  "  GeoRouting_Asia_China_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_China_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_China_GeoIP.yaml}",
  "  GeoRouting_Asia_EastSouth_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_EastSouth_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_EastSouth_GeoIP.yaml}",
  "  GeoRouting_Asia_East_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_East_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_East_GeoIP.yaml}",
  "  GeoRouting_Asia_South_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_South_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_South_GeoIP.yaml}",
  "  GeoRouting_Asia_West_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Asia_West_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Asia_West_GeoIP.yaml}",
  "  GeoRouting_Europe_East_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Europe_East_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Europe_East_GeoIP.yaml}",
  "  GeoRouting_Europe_West_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Europe_West_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Europe_West_GeoIP.yaml}",
  "  GeoRouting_Oceania_GeoIP: {type: http, behavior: classical, interval: 86400, url: \"https://raw.githubusercontent.com/Accademia/Additional_Rule_For_Clash/main/GeoRouting_For_IP/GeoRouting_Oceania_GeoIP.yaml\", path: ./ruleset/Accademia/GeoRouting_Oceania_GeoIP.yaml}",
  "",
  "proxy-groups:",
  "  - name: PROXY",
  "    type: select",
...
function parseNodeUri(uri) {
  try {
    ...
    if (uri.startsWith('hysteria2://') || uri.startsWith('hy2://')) {
        ...
        let insecure = isTruthyParam(params.get('insecure')) || isTruthyParam(params.get('allowInsecure'));
        let res = `  - name: "${name}"\n    type: hysteria2\n    server: "${server}"\n    port: ${port}\n    password: "${password}"`;
        if (sni) res += `\n    sni: "${sni}"`;
    ...
    if (uri.startsWith('vless://') || uri.startsWith('trojan://') || uri.startsWith('ss://')) {
      ...
      let insecure = isTruthyParam(params.get('insecure')) || isTruthyParam(params.get('allowInsecure')) || isTruthyParam(params.get('skip-cert-verify'));
      let network = params.get('type') || 'tcp';
      let path = params.get('path') || '/';
      let sni = params.get('sni') || '';
      let host = params.get('host') || '';
      let servername = sni || (network === 'ws' && tls ? host : '');
  ...
  async fetch(request, env, ctx) {
    try {
      ...
      const htmlLines = [
        ...
        "  <title>Clash Matrix Studio V5.3</title>",
        ...
        "      <div>",
        "        <h1 class=\"text-xl font-bold tracking-tight text-white flex items-center gap-2\">🌐 Clash Matrix Studio <span class=\"text-xs bg-gray-800 text-gray-400 px-2 py-0.5 rounded\">V5.3 终极自愈版</span></h1>",
        ...
        "       });",
        "    }",
        "    function renumberNodeRows() {",
        "       document.querySelectorAll('#nodes-render-bucket .node-row .node-index-badge').forEach((badge, index) => {",
        ...
        "           '<span class=\"node-index-badge text-[10px] font-bold text-blue-300 bg-gray-900 border border-gray-700 rounded px-2 py-0.5 shrink-0\">#' + activeRenderCount + '</span>' +",
