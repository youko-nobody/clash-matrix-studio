  ...
  async fetch(request, env, ctx) {
    try {
      ...
      const htmlLines = [
        ...
        "      .manual-node-box textarea { min-height: 96px !important; }",
        "      #nodes-render-bucket .node-row { flex-direction: column; align-items: stretch; gap: 10px; }",
        "      #nodes-render-bucket .node-row > .flex-1 { padding-right: 0; border-right: 0; width: 100%; }",
        "      #nodes-render-bucket .node-row > button { width: 100%; margin-left: 0; min-height: 44px; }",
        "      #nodes-render-bucket .node-row .drag-handle { width: 100%; }",
        "      #nodes-render-bucket .node-row .node-index-badge { align-self: flex-start; }",
